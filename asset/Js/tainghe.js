// lấy dữ liệu từ api
var apiUrl = "http://localhost:3000/api/tainghe";
function start() {
  getSanPham(render);
}
...
function render(SanPham) {
  ...
  productArrTN = SanPham;
  // productArrTN.concat(SanPham, Ss)
  card.innerHTML = htmls.join("");
  // productArrTN.push(SanPham)
  // console.log(productArrTN)
  layThongTinSP();
  soLuong();
  // searchProduct();
}
...
payMents.addEventListener("click", function () {
  ...
  var tong1 = document.querySelector('.tong1')
  var tong2 = document.querySelector('.tong2')
  tong1.innerHTML = arrTong
});
