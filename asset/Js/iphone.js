// lấy dữ liệu từ api
var apiUrlIphone = "http://localhost:3000/api/iphone";
function start() {
  getSanPham(render);
}
...
function render(SanPham) {
  ...
  productArr = SanPham;
  // productArr.concat(SanPham, Ss)
  card.innerHTML = htmls.join("");
  // productArr.push(SanPham)
...
// const hienthiTimKiem = document.querySelector('.hienthiTimKiem')
// const inputSearch = document.querySelector(".inputSearch");
// const overlayTimKiem = document.querySelector(".overlayTimKiem");
...
//   var seachFind = productArr.filter((value) => {
...
//       <p>${value.tensp}</p>
//       <i onclick="addCartTimKiem()" class="fa-sharp fa-solid fa-cart-plus addCartTimKiem"></i>
//     </div>
//     `
//   })
